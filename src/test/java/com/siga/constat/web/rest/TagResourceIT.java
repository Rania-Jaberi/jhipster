...
import com.siga.constat.repository.TagRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).lastName(DEFAULT_LAST_NAME);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getLastName()).isEqualTo(DEFAULT_LAST_NAME);
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
        ...
        assertThat(testTag.getLastName()).isEqualTo(UPDATED_LAST_NAME);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).lastName(UPDATED_LAST_NAME);
