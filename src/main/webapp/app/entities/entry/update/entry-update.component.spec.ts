  ...
  describe('Entry Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Blog query and add missing value', () => {
        ...
        const blog: IBlog = { id: 59788 };
        entry.blog = blog;

        const blogCollection: IBlog[] = [{ id: 38750 }];
      ...
      it('Should call Tag query and add missing value', () => {
        const entry: IEntry = { id: 456 };
        const tags: ITag[] = [{ id: 90716 }];
        entry.tags = tags;

        const tagCollection: ITag[] = [{ id: 86960 }];
      ...
      it('Should update editForm', () => {
        const entry: IEntry = { id: 456 };
        const blog: IBlog = { id: 50952 };
        entry.blog = blog;
        const tags: ITag = { id: 16381 };
        entry.tags = [tags];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const entry = { id: 123 };
        spyOn(entryService, 'update').and.returnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        spyOn(entryService, 'create').and.returnValue(saveSubject);
        spyOn(comp, 'previousState');
        activatedRoute.data = of({ entry });
        comp.ngOnInit();
