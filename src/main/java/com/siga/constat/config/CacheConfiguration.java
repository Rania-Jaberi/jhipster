package com.siga.constat.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.siga.constat.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.siga.constat.repository.UserRepository.USERS_BY_EMAIL_CACHE);
